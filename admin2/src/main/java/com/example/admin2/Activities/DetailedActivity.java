...
//                    StyleableToast.makeText(getApplicationContext(),name.getText().toString()+" Added To Cart", Toast.LENGTH_LONG, R.style.mytoast).show();
                    Toast.makeText( DetailedActivity.this, quantity.getText().toString()+" Items Of "+name.getText().toString()+" Added To Cart", Toast.LENGTH_LONG ).show( );
                }
            } );
    }
}